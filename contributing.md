# Contributing to pixie-date

First and foremost, thank you! We appreciate that you want to contribute to pixie-date, your time is valuable, and your contributions mean a lot to us.
...
**Showing support for pixie-date**

Please keep in mind that open source software is built by people like you, who spend their free time creating things the rest the community can use.

Don't have time to contribute? No worries, here are some other ways to show your support for pixie-date:

- star the [project](https://github.com/seanc/pixie-date)
- tweet your support for pixie-date
...
- **version**: please note the version of pixie-date are you using
...
[so]: http://stackoverflow.com/questions/tagged/pixie-date